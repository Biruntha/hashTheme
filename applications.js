        ...
        generateKeys: function(){            
            ...
            jagg.post("/site/blocks/subscription/subscription-add/ajax/subscription-add.jag", {
                ...
                if (!result.error) {
                    ...
                    '<input type="text" readonly="readonly" size=100 class="form-control consumer_secret" title="Consumer Secret" id="ConsumerSecret" value="' +
                    this.app.ConsumerSecret+'"><div class="input-group-btn"><button class="btn btn-default copy-button" data-clipboard-text="' +
                    this.app.ConsumerSecret+'" type="button" title="Copy"><i class="fw fw-copy"></i></button></div></div></div>' +
                    '<div class="form-group add-margin-top-5x"><label>' + i18n.t("Access Token") + '</label><div class="input-group">' +
